...
pub fn initialize_all_plugin_factories() {
    ...
    INIT.get_or_init(|| {
        ...
        // List of all plugin factory statics
        init_factories!(
            crate::plugins::cache::CACHE_PLUGIN_FACTORY,
            crate::plugins::forward::FORWARD_PLUGIN_FACTORY,
            crate::plugins::dataset::hosts::HOSTS_PLUGIN_FACTORY,
            crate::plugins::acl::QUERY_ACL_PLUGIN_FACTORY,
            crate::plugins::dataset::arbitrary::ARBITRARY_PLUGIN_FACTORY,
            crate::plugins::dataset::domain_set::DOMAIN_SET_PLUGIN_FACTORY,
            crate::plugins::dataset::ip_set::IP_SET_PLUGIN_FACTORY,
            crate::plugins::executable::ratelimit::RATE_LIMIT_PLUGIN_FACTORY,
            crate::plugins::executable::ros_addrlist::ROS_ADDRLIST_PLUGIN_FACTORY,
            crate::plugins::executable::black_hole::BLACKHOLE_PLUGIN_FACTORY,
            crate::plugins::executable::fallback::FALLBACK_PLUGIN_FACTORY,
            crate::plugins::executable::redirect::REDIRECT_PLUGIN_FACTORY,
            crate::plugins::executable::edns0opt::EDNS0_OPT_PLUGIN_FACTORY,
            crate::plugins::executable::reverse_lookup::REVERSE_LOOKUP_PLUGIN_FACTORY,
            crate::plugins::executable::dual_selector::DUAL_SELECTOR_PLUGIN_FACTORY,
            crate::plugins::geoip::GEO_IP_PLUGIN_FACTORY,
            crate::plugins::geosite::GEO_SITE_PLUGIN_FACTORY,
            crate::plugins::domain_validator::DOMAIN_VALIDATOR_PLUGIN_FACTORY,
        );

        #[cfg(feature = "cron")]
        init_factories!(
            crate::plugins::cron::CRON_PLUGIN_FACTORY,
            crate::plugins::executable::downloader::DOWNLOADER_PLUGIN_FACTORY,
        );
...
pub fn initialize_all_exec_plugin_factories() {
    ...
    EXEC_INIT.get_or_init(|| {
        ...
        init_factories!(
            crate::plugins::executable::ttl::TTL_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::black_hole::BLACKHOLE_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::sleep::SLEEP_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::debug_print::DEBUG_PRINT_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::drop_resp::DROP_RESP_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::fallback::FALLBACK_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::query_summary::QUERY_SUMMARY_PLUGIN_EXEC_FACTORY,
            crate::plugins::flow::accept::ACCEPT_PLUGIN_EXEC_FACTORY,
            crate::plugins::flow::goto::GOTO_PLUGIN_EXEC_FACTORY,
            crate::plugins::flow::jump::JUMP_PLUGIN_EXEC_FACTORY,
            crate::plugins::flow::reject::REJECT_PLUGIN_EXEC_FACTORY,
            crate::plugins::flow::prefer_ipv4::PREFER_IPV4_PLUGIN_EXEC_FACTORY,
            crate::plugins::flow::prefer_ipv6::PREFER_IPV6_PLUGIN_EXEC_FACTORY,
            crate::plugins::flow::return_plugin::RETURN_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::ipset::IP_SET_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::nftset::NFT_SET_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::ecs::ECS_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::collector::METRICS_COLLECTOR_PLUGIN_EXEC_FACTORY,
            crate::plugins::executable::mark::MARK_PLUGIN_EXEC_FACTORY,
        );
