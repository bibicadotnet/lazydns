...
## Plugin registry
List of registered plugin types and short descriptions.

## API docs
Link to `cargo doc` generated HTML for developers.

---

TODO: Generate a machine-readable config schema if useful.