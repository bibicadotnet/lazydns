...
// Integration tests for DoH (HTTPS) and DoT (TLS) paths.
// These tests duplicate minimal test-server helpers so they can run as
// top-level integration tests (they cannot access crate::test_helpers).
